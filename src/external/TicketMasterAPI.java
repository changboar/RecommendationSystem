...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "iNfAOLxJ7iT5I4KSuBMY54MlxOkTPi96";
	...
	public List<Item> search(double lat, double lon, String keyword) {
        ...
        try {
			...
			// in this line, we 1. send get request 2. get response code
			System.out.println("Sending 'GET' request to URL: " + URL);
			System.out.println("Response Code: " +  responseCode);
			
			BufferedReader in = new BufferedReader(new InputStreamReader(connection.getInputStream())); // get data from server 
			// getOutputStream(), get data from client(connection)
			// larger stream, use BufferedReader
